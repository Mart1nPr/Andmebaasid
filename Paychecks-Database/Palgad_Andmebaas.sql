...
INSERT INTO `ettevõte` VALUES (1,'LEV','Levira'),(2,'Nor','Nortal');
/*!40000 ALTER TABLE `ettevõte` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `maksetesumma`
--

DROP TABLE IF EXISTS `maksetesumma`;
/*!50001 DROP VIEW IF EXISTS `maksetesumma`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `maksetesumma` AS SELECT 
 1 AS `Eesnimi`,
 1 AS `Perekonnanimi`,
 1 AS `MakseteSumma`*/;
...
INSERT INTO `palgamakse` VALUES (1,1,2500.00,'2023-01-15'),(2,2,3000.00,'2023-02-15');
...
INSERT INTO `palk` VALUES (1,2500.00,1,1),(2,3000.00,1,2);
...
INSERT INTO `tööline` VALUES (1,'12345678901','Martin','Pruus');
/*!40000 ALTER TABLE `tööline` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Final view structure for view `maksetesumma`
--
...
/*!50001 VIEW `maksetesumma` AS select `t`.`Eesnimi` AS `Eesnimi`,`t`.`Perekonnanimi` AS `Perekonnanimi`,sum(`pm`.`Summa`) AS `MakseteSumma` from ((`tööline` `t` join `palk` `p` on((`t`.`Id` = `p`.`TöölineId`))) join `palgamakse` `pm` on((`p`.`Id` = `pm`.`PalkId`))) group by `t`.`Id` */;
...
-- Dump completed on 2024-10-24 11:04:37
